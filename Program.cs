    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            List<ProductReview> productReviewList = new List<ProductReview>()
            {
                ...
                new ProductReview(){ProducID=3,UserID=10,Rating=5,Review="Good",isLike=true},
                new ProductReview(){ProducID=4,UserID=3,Rating=6,Review="Good",isLike=false},
                new ProductReview(){ProducID=5,UserID=10,Rating=2,Review="Nice",isLike=true},
                ...
                new ProductReview(){ProducID=12,UserID=10,Rating=2,Review="Good",isLike=true},
                ...
                new ProductReview(){ProducID=10,UserID=3,Rating=6,Review="Good",isLike=false},
                new ProductReview(){ProducID=10,UserID=4,Rating=2,Review="Nice",isLike=true},
                new ProductReview(){ProducID=10,UserID=1,Rating=1,Review="Bas",isLike=true},
                new ProductReview(){ProducID=10,UserID=5,Rating=1,Review="Good",isLike=false},
            ...
            ////UC12: User ID 10Ascending order
            manager.RetrieveRecordsWithUserId10(productReviewList);
